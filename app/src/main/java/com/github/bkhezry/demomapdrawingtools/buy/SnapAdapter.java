...
public class SnapAdapter extends RecyclerView.Adapter<SnapAdapter.ViewHolder> implements GravitySnapHelper.SnapListener {
    ...
    public SnapAdapter(AppCompatActivity activity) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = viewType == VERTICAL ? LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_snap_vertical_cattle, parent, false)
                : LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_snap_cattle, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.recyclerView.setAdapter(new Adapter(activity, snap.getGravity() == Gravity.START
